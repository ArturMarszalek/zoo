...
class TestAnimal {
    ...
    void shouldDisplayBears() {
        ...
        assertEquals("I am the Polarbear with weigth 50.0. My last meal was 2020-02-22", polarBear.diplay());
        BrownBear brownBear = new BrownBear(LocalDate.now());
        assertEquals("I am the Brownbear with weigth 100.0. My last meal was 2020-02-22", brownBear.diplay());
        BlackBear blackBear = new BlackBear(LocalDate.now());
        assertEquals("I am the Blackbear with weigth 200.0. My last meal was 2020-02-22", blackBear.diplay());
        PlushBear plushBear = new PlushBear();
